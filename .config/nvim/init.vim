...
" MAPPINGS --------------------------------------------------------------- {{{
    ...
    nnoremap <C-Right>  :vertical resize -2<CR> Now used for swithing tabs
    nnoremap <C-Left> :vertical resize +2<CR> Now used for switching tabs
    ...
    " Optional: If you also want to remap for insert mode for some reason
    " imap <C-Q> <C-V>
